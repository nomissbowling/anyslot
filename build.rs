...
//    mk_bindings("./anyslot", "anyslot.h", "./anyslot", "anyslot_bindings.rs",
//      false, true);
  }

//  println!("cargo:rustc-link-search=./anyslot/lib");
//  println!("cargo:rustc-link-lib=anyslot");
}
